        ...
        <section className="pt-32 pb-20 px-4 bg-gradient-to-br from-background via-primary/5 to-secondary/5">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              Scholar Swipe helps students discover personalized scholarships in seconds — no more long searches 
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                  <p>
                    Scholar Swipe uses AI to match students with scholarships that fit their goals, background, 
        ...
        <section className="py-20 px-4">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <h2 className="font-display text-4xl md:text-5xl font-bold mb-6">Meet the Founder</h2>
              <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                Built by a student, for students. We understand the scholarship struggle because we've lived it.
              </p>
            </div>
            ...
            <div className="mt-12 text-center max-w-3xl mx-auto">
              <p className="text-lg text-muted-foreground leading-relaxed">
                Built by a student from the Lehigh Valley with a shared mission: 
