          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="rounded-3xl p-8 bg-white border border-border shadow-sm">
              ...
              <p className="text-muted-foreground mb-6">
                Help us improve Scholar Swipe by sharing your thoughts, suggestions, or reporting any issues.
              </p>
            ...
            <div className="rounded-3xl p-8 bg-white border border-border shadow-sm">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Is Scholar Swipe free to use?</h3>
                    <p className="text-sm text-muted-foreground">
                      Yes! Scholar Swipe is completely free. No hidden fees, no credit card required.
                    </p>
                  </div>
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">What makes Scholar Swipe different?</h3>
                    <p className="text-sm text-muted-foreground">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-foreground mb-2">Can I apply directly through Scholar Swipe?</h3>
                    <p className="text-sm text-muted-foreground">
