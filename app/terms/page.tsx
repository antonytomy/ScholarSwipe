            ...
            <div className="prose prose-lg max-w-none space-y-6">
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  By accessing and using Scholar Swipe ("the Service"), you accept and agree to be bound by the terms and provision of this agreement. If you do not agree to abide by the above, please do not use this service.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Scholar Swipe is an AI-powered scholarship matching platform that helps students discover and apply for educational funding opportunities. Our service includes scholarship recommendations, application tracking, and educational resources.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Scholar Swipe shall not be liable for any indirect, incidental, special, consequential, or punitive damages, including without limitation, loss of profits, data, use, goodwill, or other intangible losses, resulting from your use of the Service.
                </p>
              </section>
